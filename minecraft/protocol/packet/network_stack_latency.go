...
// over the entire Minecraft item, rather than the RakNet latency. It has other usages too, such as the
...
type NetworkStackLatency struct {
	// Timestamp is the timestamp of the network item latency packet. The client will, if NeedsResponse is
